...
public static class AllTalk
{
    ...
    private static int language_change_rate = 20; // 


    public static string[] contents = new string[] {
        "最近森林的同伴都變的怪怪的，想必北方的賢者必定知道些什麼。" ,
        "Hi" , "OK" ,"Bye" , "主角: 怎摸感覺身體怪怪的，難道…" ,
        "我也要… 變成… 那樣的怪物了嗎…" ,
        "阿~…" ,// 4~6 死亡
        ...
        "當然(もちろん)", "很好，那就交給你了，分別是西方的 XXX 跟東方的 XXX，你的時間不多了，動作快。" // 14



    };
    public static string[] people = new string[] {
        "主角" , "Wu", "Wang", "Wu" ,  "主角" ,  "主角" ,  "主角" ,//
